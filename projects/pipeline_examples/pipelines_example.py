...
def run_dummy_pipeline():
    dummy_pipeline = InferenceComposer(  # composer wraps highest level pipeline to orchestrate execution
                        InferencePipeline("dummy_answer", 1,  [  # highest level pipeline serving as entrypoint
                            InferencePipeline("dummy_sentence", 3, [  # lower level pipeline generating at most 3 sentences for the answer
